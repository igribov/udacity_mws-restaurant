...
var CACHE_VER = 'v1548530075544';
var CACHE_NAME = CACHE_VER + '_static';
var IMG_CACHE_NAME = CACHE_VER + '_img';
...
function servePhoto(request) {
  ...
  return caches.match(storeKey, { ignoreSearch: true }).then(function (resp) {
    if (resp) {
      return resp;
    }
